...
def test_get_all_lectures(create_valid_lecture, create_second_valid_lecture, client):
    """
...
@pytest.mark.django_db
def test_get_single_lecture(create_valid_lecture, client):
    """
...
@pytest.mark.django_db
def test_handle_non_existed_lecture_properly(client):
    """
